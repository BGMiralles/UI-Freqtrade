...
export class AddForeignKeyToSellTecnicals1702491957943 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropForeignKey("sell_technicals", "technical_resources_id");
    }
